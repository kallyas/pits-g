...
$(function () {
  ...
  // --------------------------------------------- //
  $("#countdown").countdown({
    until: $.countdown.UTCDate(+10, 2022, 8, 19),
    format: "D",
  });
  ...
  // --------------------------------------------- //
  const stayIntouch = document.querySelector("#stayintouch-form");
  stayIntouch.addEventListener("submit", (e) => {
    e.preventDefault();
    emailjs
      .sendForm("service_j09xasf", "template_j3v95l4", stayIntouch)
      .then(function (response) {
        ...
        setTimeout(function () {
          ...
          $(".stayintouch").find(".form").delay(300).removeClass("is-hidden");
          $(".stayintouch-form").trigger("reset");
        }, 5000);
      })
  ...
  if (contact_form) {
    contact_form.addEventListener("submit", (e) => {
      e.preventDefault();
      emailjs
        .sendForm("service_j09xasf", "template_vi64q79", contact_form)
        .then(function (response) {
          console.log("SUCCESS!", response.status, response.text);
